...
GENERAL_MATH = SubjectCurriculum(
    ...
    units=[
        Unit(
            id="gmath-arithmetic", title="Arithmetic", title_bn="পাটিগণিত",
            description="Ratio, percentage, profit-loss, time-speed-distance",
            description_bn="অনুপাত, শতকরা, লাভ-ক্ষতি, সময়-বেগ-দূরত্ব",
            icon="🔢", order=1,
            lessons=[
                _lesson("gm-01", "Ratio, Percentage & Profit-Loss", "অনুপাত, শতকরা ও লাভ-ক্ষতি",
                        "Ratio, proportion, percentage, profit/loss, discount",
                        "অনুপাত, সমানুপাত, শতকরা, লাভ/ক্ষতি, ছাড়",
                        Difficulty.EASY, 1),
                _lesson("gm-02", "Time, Speed & Distance", "সময়, বেগ ও দূরত্ব",
                        "Average speed, relative motion, trains, boats, work-time",
                        "গড় বেগ, আপেক্ষিক গতি, ট্রেন, নৌকা, কাজ-সময়",
                        Difficulty.MEDIUM, 2),
            ],
        ),
        Unit(
            id="gmath-algebra", title="Basic Algebra", title_bn="মৌলিক বীজগণিত",
            description="Equations, sets, functions, logarithms",
            description_bn="সমীকরণ, সেট, ফাংশন, লগারিদম",
            icon="🅰️", order=2,
            lessons=[
                _lesson("gm-03", "Equations & Inequalities", "সমীকরণ ও অসমতা",
                        "Linear, quadratic, simultaneous, word problems",
                        "সরল, দ্বিঘাত, যুগপৎ, ব্যবহারিক সমস্যা",
                        Difficulty.MEDIUM, 1, ["b²-4ac"]),
                _lesson("gm-04", "Sets, Functions & Logarithms", "সেট, ফাংশন ও লগারিদম",
                        "Venn diagrams, domain/range, log rules",
                        "ভেন চিত্র, ডোমেইন/রেঞ্জ, লগের নিয়ম",
                        Difficulty.MEDIUM, 2, ["log rules"]),
            ],
        ),
        Unit(
            id="gmath-stats", title="Statistics & Probability", title_bn="পরিসংখ্যান ও সম্ভাব্যতা",
            description="Mean, median, mode, probability, permutations",
            description_bn="গড়, মধ্যমা, প্রচুরক, সম্ভাব্যতা, বিন্যাস",
            icon="📈", order=3,
            lessons=[
                _lesson("gm-05", "Central Tendency & Probability", "কেন্দ্রীয় প্রবণতা ও সম্ভাব্যতা",
                        "Mean, median, mode, basic probability, counting",
                        "গড়, মধ্যমা, প্রচুরক, মৌলিক সম্ভাব্যতা, গণনা",
                        Difficulty.MEDIUM, 1, ["P(A∩B)", "nCr"]),
            ],
        ),
    ],
)
